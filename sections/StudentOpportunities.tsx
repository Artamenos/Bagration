...
const opportunities: Opportunity[] = [
  {
    ...
    description:
      "Первое бесплатное занятие помогает спокойно познакомиться с клубом: тренер оценивает уровень подготовки, объясняет формат группы и отвечает на организационные вопросы.",
    icon: "trial",
    imageFirst: true,
  },
  {
    ...
    description:
      "Основная работа строится на постоянной практике: техника киокушин, общая физическая подготовка, координация, дисциплина и работа в парах.",
    icon: "training",
    imageFirst: false,
  },
  {
    ...
    description:
      "В процессе обучения ученики готовятся к аттестации на пояса. Тренеры помогают разобраться в требованиях и выстроить базовую технику.",
    icon: "exam",
    imageFirst: true,
  },
  {
    title: "Турниры и сборы",
    description:
      "Клуб участвует в соревнованиях разного уровня — от клубных до всероссийских — и проводит учебно-тренировочные сборы. Это дополнительная практика, опыт выступлений и работа в команде.",
    icon: "competition",
    imageFirst: false,
  },
  {
    title: "Летний лагерь",
    description:
      "Выездной формат с тренировками, режимом и командной средой. Лагерь помогает укрепить дисциплину, поддерживать тренировочный ритм и лучше узнать команду.",
    icon: "camp",
    imageFirst: true,
  },
];
...
const summaryItems = [
  {
    title: "подбор группы",
    text: "тренер оценивает уровень и рекомендует подходящий формат занятий",
  },
  {
    title: "техника и физическая подготовка",
    text: "техника, ОФП, развитие координации, работа в парах и совместные спарринги",
  },
  {
    title: "подготовка к аттестациям",
    text: "понятные требования и планомерная подготовка к аттестации",
  },
  {
    title: "турниры и сборы",
    text: "участие в турнирах, учебных сборах и командных мероприятиях",
  },
  {
    title: "команда и дисциплина",
    text: "выездные тренировки, дисциплина и общение внутри команды",
  },
];
      ...
      <div className="site-container grid grid-cols-1 gap-12 sm:gap-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
        ...
        <div className="order-1 h-fit lg:order-2 lg:sticky lg:top-28 lg:self-start">
          ...
          <p className="mt-4 max-w-[560px] text-base leading-6 text-neutral-800 sm:mt-5 sm:text-xl sm:leading-7">
            Регулярные занятия дополняются соревнованиями, аттестациями, сборами и летними лагерями. Такой формат помогает последовательно укреплять технику, физическую форму и уверенность.
          </p>
